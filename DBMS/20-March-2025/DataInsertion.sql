...
(604, 3, 'Alice Wonderland', 'aliceSecure@99', 'alice.w@example.com', '8765432109', 'F'),
...
(607, 3, 'Tom Hanks', 'tomActor@88', 'tom.hanks@example.com', '7654321890', 'M'),
...
(611, 3, 'Diana Prince', 'wonder!woman', 'diana.prince@example.com', '9132467890', 'F'),
...
(614, 3, 'Tony Stark', 'ironman#3000', 'tony.stark@example.com', '9456789123', 'M'),
...
(621, 3, 'Scott Lang', 'antman#tiny', 'scott.lang@example.com', '9834567123', 'M'),
...
(624, 3, 'Shuri', 'shuri@tech', 'shuri@example.com', '9867890456', 'F'),
...
(628, 3, 'Pepper Potts', 'pepper@secure', 'pepper.potts@example.com', '9801234890', 'F'),
...
(632, 3, 'Gamora', 'gamora@secure', 'gamora@example.com', '9945678904', 'F'),
(633, 2, 'Nebula', 'nebula@cyber', 'nebula@example.com', '9956789015', 'F'),
(634, 1, 'Star-Lord', 'star#lord', 'starlord@example.com', '9967890126', 'M'),
(635, 3, 'Rocket Raccoon', 'rocket@blast', 'rocket@example.com', '9978901237', 'M'),
...
(639, 3, 'Yondu', 'yondu@arrow', 'yondu@example.com', '9112345671', 'M'),
...
(643, 3, 'Hank Pym', 'hank@antman', 'hank.pym@example.com', '9156789015', 'M'),
...
(646, 3, 'MJ Watson', 'mj@spidey', 'mj.watson@example.com', '9189012348', 'F'),
...
(650, 3, 'Korg', 'korg@rocks', 'korg@example.com', '9223456782', 'M');


-- Insert data into 'payment' table
INSERT INTO payment (PaymentID, PaymentMode, PaymentTime, PaymentAmount)
VALUES
(301, 'CreditCard', '2025-03-20', 70000),
(302, 'NetBanking', '2025-03-21', 85000),
(303, 'UPI', '2025-03-22', 3000),
(304, 'CreditCard', '2025-03-23', 25000),
(305, 'Cash', '2025-03-24', 500),
(306, 'DebitCard', '2025-03-25', 45000),
(307, 'NetBanking', '2025-03-26', 12000),
(308, 'UPI', '2025-03-27', 800),
(309, 'CreditCard', '2025-03-28', 150000),
(310, 'Cash', '2025-03-29', 2500),
(311, 'DebitCard', '2025-03-30', 6000),
(312, 'UPI', '2025-03-31', 4200),
(313, 'NetBanking', '2025-04-01', 77000),
(314, 'CreditCard', '2025-04-02', 9000),
(315, 'Cash', '2025-04-03', 1800),
(316, 'DebitCard', '2025-04-04', 34000),
(317, 'UPI', '2025-04-05', 300),
(318, 'NetBanking', '2025-04-06', 110000),
(319, 'CreditCard', '2025-04-07', 59000),
(320, 'DebitCard', '2025-04-08', 27000),
(321, 'Cash', '2025-04-09', 15000),
(322, 'UPI', '2025-04-10', 5000),
(323, 'NetBanking', '2025-04-11', 78000),
(324, 'CreditCard', '2025-04-12', 9600),
(325, 'DebitCard', '2025-04-13', 4300),
(326, 'Cash', '2025-04-14', 1200),
(327, 'UPI', '2025-04-15', 62000),
(328, 'NetBanking', '2025-04-16', 57000),
(329, 'CreditCard', '2025-04-17', 8500),
(330, 'Cash', '2025-04-18', 2900),
(331, 'DebitCard', '2025-04-19', 19000),
(332, 'UPI', '2025-04-20', 750),
(333, 'NetBanking', '2025-04-21', 102000),
(334, 'CreditCard', '2025-04-22', 8800),
(335, 'Cash', '2025-04-23', 3100),
(336, 'DebitCard', '2025-04-24', 32000),
(337, 'UPI', '2025-04-25', 450),
(338, 'NetBanking', '2025-04-26', 98000),
(339, 'CreditCard', '2025-04-27', 7400),
(340, 'DebitCard', '2025-04-28', 4900),
(341, 'Cash', '2025-04-29', 1700),
(342, 'UPI', '2025-04-30', 34000),
(343, 'NetBanking', '2025-05-01', 45000),
(344, 'CreditCard', '2025-05-02', 6800),
(345, 'DebitCard', '2025-05-03', 2900),
(346, 'Cash', '2025-05-04', 800),
(347, 'UPI', '2025-05-05', 6200),
(348, 'NetBanking', '2025-05-06', 87000),
(349, 'CreditCard', '2025-05-07', 9100),
(350, 'Cash', '2025-05-08', 2400);

-- Insert data into 'orders' table
INSERT INTO orders (OrderID, UserID, PaymentID, OrderDate, DeleiverDate, orderStatus, ShippingAddress)
VALUES
(401, 601, 301, '2024-11-26', '2024-12-01', 'Shipped', '123, ABC Street, Hyderabad'),
(402, 602, 302, '2024-11-27', '2024-12-02', 'Delivered', '456, XYZ Avenue, Mumbai'),
(403, 603, 303, '2024-11-28', '2024-12-03', 'Cancelled', '789, LMN Lane, Chennai'),
(404, 604, 304, '2024-11-29', '2024-12-04', 'Pending', '321, OPQ Road, Bengaluru'),
(405, 605, 305, '2024-11-30', '2024-12-05', 'Delivered', '654, GHI Colony, Kolkata'),
(406, 606, 306, '2024-12-01', '2024-12-06', 'Shipped', '876, TUV Street, Pune'),
(407, 607, 307, '2024-12-02', '2024-12-07', 'Cancelled', '987, DEF Avenue, Ahmedabad'),
(408, 608, 308, '2024-12-03', '2024-12-08', 'Pending', '543, JKL Lane, Jaipur'),
(409, 609, 309, '2024-12-04', '2024-12-09', 'Delivered', '210, RST Road, Lucknow'),
(410, 610, 310, '2024-12-05', '2024-12-10', 'Shipped', '111, UVW Street, Chandigarh'),
(411, 611, 311, '2024-12-06', '2024-12-11', 'Delivered', '222, XYZ Lane, Patna'),
(412, 612, 312, '2024-12-07', '2024-12-12', 'Pending', '333, GHI Avenue, Surat'),
(413, 613, 313, '2024-12-08', '2024-12-13', 'Cancelled', '444, DEF Street, Nagpur'),
(414, 614, 314, '2024-12-09', '2024-12-14', 'Delivered', '555, JKL Road, Bhopal'),
(415, 615, 315, '2024-12-10', '2024-12-15', 'Shipped', '666, MNO Avenue, Ludhiana'),
(416, 616, 316, '2024-12-11', '2024-12-16', 'Pending', '777, ABC Lane, Agra'),
(417, 617, 317, '2024-12-12', '2024-12-17', 'Cancelled', '888, PQR Road, Varanasi'),
(418, 618, 318, '2024-12-13', '2024-12-18', 'Delivered', '999, STU Avenue, Thiruvananthapuram'),
(419, 619, 319, '2024-12-14', '2024-12-19', 'Shipped', '123, OPQ Street, Coimbatore'),
(420, 620, 320, '2024-12-15', '2024-12-20', 'Pending', '456, UVW Road, Guwahati'),
(421, 621, 321, '2024-12-16', '2024-12-21', 'Delivered', '789, XYZ Lane, Ranchi'),
(422, 622, 322, '2024-12-17', '2024-12-22', 'Cancelled', '321, GHI Street, Bhubaneswar'),
(423, 623, 323, '2024-12-18', '2024-12-23', 'Pending', '654, DEF Avenue, Goa'),
(424, 624, 324, '2024-12-19', '2024-12-24', 'Shipped', '876, JKL Lane, Mysuru'),
(425, 625, 325, '2024-12-20', '2024-12-25', 'Delivered', '987, MNO Road, Madurai'),
(426, 626, 326, '2024-12-21', '2024-12-26', 'Cancelled', '543, OPQ Street, Nashik'),
(427, 627, 327, '2024-12-22', '2024-12-27', 'Shipped', '210, UVW Avenue, Kanpur'),
(428, 628, 328, '2024-12-23', '2024-12-28', 'Pending', '111, XYZ Lane, Amritsar'),
(429, 629, 329, '2024-12-24', '2024-12-29', 'Delivered', '222, GHI Road, Vijayawada'),
(430, 630, 330, '2024-12-25', '2024-12-30', 'Shipped', '333, DEF Street, Kota'),
(431, 631, 331, '2024-12-26', '2024-12-31', 'Cancelled', '444, JKL Avenue, Udaipur'),
(432, 632, 332, '2024-12-27', '2025-01-01', 'Pending', '555, ABC Lane, Jodhpur'),
(433, 633, 333, '2024-12-28', '2025-01-02', 'Delivered', '666, PQR Road, Tirupati'),
(434, 634, 334, '2024-12-29', '2025-01-03', 'Shipped', '777, STU Street, Kozhikode'),
(435, 635, 335, '2024-12-30', '2025-01-04', 'Cancelled', '888, UVW Avenue, Meerut'),
(436, 636, 336, '2024-12-31', '2025-01-05', 'Pending', '999, XYZ Lane, Noida'),
(437, 637, 337, '2025-01-01', '2025-01-06', 'Shipped', '123, GHI Street, Vellore'),
(438, 638, 338, '2025-01-02', '2025-01-07', 'Delivered', '456, DEF Road, Salem'),
(439, 639, 339, '2025-01-03', '2025-01-08', 'Shipped', '789, JKL Avenue, Guntur'),
(440, 640, 340, '2025-01-04', '2025-01-09', 'Cancelled', '321, OPQ Lane, Warangal'),
(441, 641, 341, '2025-01-05', '2025-01-10', 'Delivered', '654, UVW Road, Durgapur'),
(442, 642, 342, '2025-01-06', '2025-01-11', 'Pending', '876, XYZ Avenue, Jamnagar'),
(443, 643, 343, '2025-01-07', '2025-01-12', 'Cancelled', '987, GHI Street, Siliguri'),
(444, 644, 344, '2025-01-08', '2025-01-13', 'Delivered', '543, DEF Lane, Aligarh'),
(445, 645, 345, '2025-01-09', '2025-01-14', 'Pending', '210, JKL Avenue, Jhansi'),
(446, 646, 346, '2025-01-10', '2025-01-15', 'Cancelled', '111, MNO Street, Gorakhpur'),
(447, 647, 347, '2025-01-11', '2025-01-16', 'Shipped', '222, OPQ Lane, Moradabad'),
(448, 648, 348, '2025-01-12', '2025-01-17', 'Pending', '333, UVW Road, Raipur'),
(449, 649, 349, '2025-01-13', '2025-01-18', 'Delivered', '444, XYZ Avenue, Jabalpur'),
(450, 650, 350, '2025-01-14', '2025-01-19', 'Cancelled', '555, ABC Street, Bareilly');
